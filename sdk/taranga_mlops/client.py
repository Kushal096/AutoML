...
class MLOpsClient:
    """
    Main client for interacting with the MLOps Platform
    ...
    def _get_headers(self) -> Dict[str, str]:
        ...
        headers["User-Agent"] = "MLOps-SDK/1.0"
    ...
    def _make_request(
        ...
        try:
            ...
            raise MLOpsError(f"Request failed: {str(e)}")
